...
# Loads .env (via monitor import)
app = Flask(__name__)
# flash() stores messages in the session; Flask refuses sessions without a secret.
app.secret_key = os.environ.get("FLASK_SECRET_KEY") or os.urandom(24)


def nav_html() -> str:
    return (
        '<p style="margin-top:1rem;"><a href="/">Dashboard</a> · '
...
@app.route("/logout")
def logout():
    """Old bookmarks: auth removed; send users to the dashboard."""
